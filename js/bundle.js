...
function cards() {
  ...
  axios.get("http://localhost:3000/menu").then(function (x) {
    x.data.forEach(function (_ref) {
      var img = _ref.img,
          altimg = _ref.altimg,
          title = _ref.title,
          descr = _ref.descr,
...
function forms(modalTimerId) {
  ...
  function postData(form) {
    form.addEventListener("submit", function (event) {
      ...
      var jsonFormatedData = JSON.stringify(object);
      Object(_services_services__WEBPACK_IMPORTED_MODULE_7__["makePostRequest"])("http://localhost:3000/requests", jsonFormatedData).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_6__["openModalLogic"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_6__["closeModalLogic"])('.modal');
    }, 4000);
  }
}
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return openModalLogic(modalSelector, modalTimerId);
    });
  });
...
function slider(_ref) {
  ...
  addZero(); // adding dots (rectangular format) at the bottom of window with sliders
  ...
  dots.forEach(function (dot) {
    dot.addEventListener("click", function (event) {
      var slideTo = event.target.getAttribute("data-slide-to");
      slideIndex = slideTo;
...
function timer(deadline) {
  ...
  function getTimeRemaining(endtime) {
    var i = Date.parse(endtime) - Date.parse(new Date());
    var days = Math.floor(i / (1000 * 60 * 60 * 24));
    var hours = Math.floor(i / (1000 * 60 * 60) % 24);
    var min = Math.floor(i / 1000 / 60 % 60);
...
document.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["openModalLogic"])(".modal", modalTimerId);
  }, 5000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])("2020-06-30");
...
var makePostRequest = /*#__PURE__*/function () {
  ...
  return function makePostRequest(_x, _x2) {
